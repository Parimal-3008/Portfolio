...
const Intro = React.forwardRef((props, ref) => {
  ...
  let str4 =
    " I am a Software Development Engineer at Bild, specializing in building scalable and efficient solutions to enhance product development and lifecycle processes for hardware companies.";
  let str = str1;
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (index < str1.length) {
        ...
        index - str1.length - str2.length - str3.length <
        str4.length + 30
      ) {
        settimer(30);
        if (window.innerWidth > 1050)
          setText4(
            line4 +
              (str4[index - str1.length - str2.length - str3.length] ?? "")
          );
        setIndex(index + 1);
      } else {
        setText2("  ");
