...
const  About=  React.forwardRef((props, ref) => {
  return (
    ...
    <div className='MyDesc'>
      ...
      <p>I am an enthusiastic web developer with a passion for creating dynamic and innovative web applications. I am graduating from NIT Surat with B.Tech degree.</p>
      ...
      <p>
        ...
        <p>
         Solving more than 1200 Data Structures and Algorithms problems on 
